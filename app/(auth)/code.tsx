      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View className="flex-1 bg-primary justify-end">
          ...
          <View className="bg-white rounded-t-2xl border border-gray-200 px-5 pt-12 pb-20 w-screen">
            <Text className="text-xl font-semibold text-center mb-4">Introduce el código</Text>
            ...
            <Pressable className="mt-2 items-center" onPress={() => { /* TODO: Resend code */ }}>
              <Text className="text-gray-500 text-xs">Volver a enviar código</Text>
            </Pressable>
